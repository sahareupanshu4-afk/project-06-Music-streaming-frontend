...
import { Mail, Lock, Eye, EyeOff, Headphones, ArrowRight, User } from 'lucide-react'
...
const Register = () => {
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4 py-12">
        ...
        >
          <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-gradient-to-br from-neon-green to-neon-cyan flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      <div className="fixed top-1/4 right-1/4 w-96 h-96 rounded-full bg-neon-pink/10 blur-3xl" />
      <div className="fixed bottom-1/4 left-1/4 w-96 h-96 rounded-full bg-neon-blue/10 blur-3xl" />
      ...
      >
        ...
        >
          ...
          <p className="text-gray-400">Begin your sound journey today</p>
        </motion.div>
